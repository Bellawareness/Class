class Main {
  ...
  /*
   * Object scoped variable. Every Main object will have its own copy of this
   * variable that it can work with independently. object scopes don't have the
   * static keyword.
   */
  ...
  public static void main(String[] args) {
    ...
    /*
     * Follow the instructions below and see what happens. Did you run across any
     * issues if so why do you think it happened? Leave it in a comment in the code.
     * If you had an issue and figured it out. How did you solve it?
     */
...
System.out.println(main.num2);
    // See how when you change main2.num2 main.num2 also changes. This is because
    // num2 is a static variable.
